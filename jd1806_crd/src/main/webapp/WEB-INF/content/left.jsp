   ...
   <TABLE class=bigtable cellSpacing=0 cellPadding=0 width=156 border=0>
		...
		<TBODY>
			...
			<TR>
							...
							<!--  内容及下环线开始   -->
				<TD width="100%">
						<c:if test="${sessionScope.user.usrRoleId<=4 && sessionScope.user.usrRoleId>1}">
					<!--  循环主menu开始   -->
					<TABLE cellSpacing=0 cellPadding=0 width=156 bgColor=#d3dae1
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="" target="mainFrame">销售机会管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="customer/1/findAllCustomer" target="mainFrame">客户信息管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
						...
						<c:if test="${sessionScope.user.usrRoleId<=3}">	
							<TABLE cellSpacing=0 cellPadding=0 width=156 bgColor=#d3dae1
						border=0>
						<TBODY>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="jfreechart/findContribute" target="mainFrame">客户贡献分析</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="jfreechart/findConstract" target="mainFrame">客户构成分析</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="product/1/showAllProduct" target="mainFrame">查询产品信息</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="product/1/showAllStorage" target="mainFrame">查询库存</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="role/showAllRole" target="mainFrame">角色管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
													...
													<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center
														...
														<TBODY>
															<TR>
																...
																<TD class=unnamed1><a href="user/1/showAllUser" target="mainFrame">用户管理</a></TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
