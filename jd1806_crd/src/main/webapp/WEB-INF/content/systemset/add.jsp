...
<form action="user/addUserSuccess" method="post" onsubmit="return check()">
<table class="query_form_table" cellSpacing=1 cellPadding=1>
	<tr>
			<td  width=100% height=30 align=left background = "images/m_table_top.jpg" colspan="6"><strong>&nbsp;<a href="add.html">新建用户</a></strong></td>
    </tr>
	<tr>
		<th>用户编号</th>
	...
	<tr>
		<th>创建人</th>
		<td><input  value="${user.usrName }" readonly size="20" /><span class="red_star">*</span></td>
	</tr>
	<tr>
    	<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
        	<a href="../help.html"><input class="common_button"  type="button" value="帮助"></a>
        	&nbsp;&nbsp;&nbsp;
			<a href="user/1/showAllUser"><input class="common_button"  type="button" value="返回"></a>
&nbsp;&nbsp;
