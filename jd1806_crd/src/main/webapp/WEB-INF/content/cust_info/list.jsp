...
<body>
	...
	<form action="customer/1/findPageByConfig" method="post">
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				<td width=100% height=32 align=center colspan=6 bgcolor=#ffffff>
					...
					href="customer/addCustomer"><input class="common_button"
	...
	<table id="data_list_table" class="data_list_table" cellSpacing=1
		...
		<tr>
			<td class="list_data_number" align="center">${customer.custId }</td>
			<td class="list_data_text" align="center">${customer.custNo }</td>
			<td class="list_data_ltext" align="center">${customer.custName }</td>
			<td class="list_data_text" align="center">${customer.custRegion }</td>
			<td class="list_data_text" align="center">${customer.custManagerName }</td>
			<td class="list_data_text" align="center">${customer.custLevelLabel }</td>
		...
		<tr>
			<th colspan="100" class="pager">共${pageInfo.total}条记录 每页 5 条 第${pageInfo.pageNum}页 <a href="cust/1/customer">首页</a>
				<c:choose>
					<c:when test="${pageInfo.hasPreviousPage }">
						<a href="customer/${pageInfo.prePage}/findAllCustomer">上一页</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					<c:when test="${pageInfo.hasNextPage }">
						<a href="customer/${pageInfo.nextPage}/findAllCustomer">下一页</a>
					</c:when>
					<c:otherwise>
						<font color="#ABA8AB">下一页</font>
					</c:otherwise>
				</c:choose>
				</font> <a href="customer/${pageInfo.nextPage}/findAllCustomer">尾页</a>
			</th>
		</tr>
	</table>
</body>
