...
<body>
	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
            	<li><a href="toIndexSuccessServlet">首页</a>|</li>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="toIndexSuccessServlet"><img src="images/logo.png"></a>
    	<div class="h3_center">
    	...
    	<div class="register_box">
    			...
    			<div class="security">
    				<form action="updateUserInFoServlet">
    					<ul class="list">
    						<li>
    								<input id="J_euserName" class="long" readonly="readonly" name="txtUser" value="${user.username}" type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="password" value="${user.password}" type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="zip" value="${user.zip}" type="text" />
    						...
    						<li>
    								<input id="J_euserName" class="long" name="phone" value="${user.phone }" type="text" />
