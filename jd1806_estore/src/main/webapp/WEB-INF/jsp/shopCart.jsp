...
<body>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="toIndexSuccessServlet"><img src="images/logo.png"  class="oneImg"></a>
...
<form action="confirm.html" method="post">
	<c:if test="${empty sessionScope.allShopCartItem }">
		<a href="toIndexSuccessServlet"><img src="images/empty_03.png" class="car"></a>
	</c:if>
	<c:if test="${!empty sessionScope.allShopCartItem }">
	...
	<c:forEach items="${sessionScope.allShopCartItem }" var="ShopCartItem">
	<div class="c_book">
		<div class="row">
			...
			<div style="float: left" class="line">
				...
				<div style="margin-left: 80px;">
					<img src="${ShopCartItem.product.img }" style="float: left; width:75px;height:75px">
					<span>${ShopCartItem.product.name }</span>
				</div>
			</div>
			<div style="float: right" class="row_right">
				<div style="margin-right: 10px">￥${ShopCartItem.product.price }元</div><!-- 单价 -->
				<div>
					<span class="jian">-</span>
					<span><input type="text" class="val" value=${ShopCartItem.num } style="text-align: center"></span>
					<span class="sum">+</span>
				</div>
				<div class="price">￥${ShopCartItem.num * ShopCartItem.product.price }元</div><!-- 小结 -->
				<div>
					<a href="delShopCartItem">删除</a>
				</div>
			</div>
		</div>	
	</div>
