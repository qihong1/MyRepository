...
<script type="text/javascript">
	function reduceCount(){
		...
		if(parseInt(numObj.value)<=1){
			var b = confirm("是否删除本条购物信息？");	
			if(b){
				numObj.parentNode.parentNode;
			}
		}
...
<body>
	...
	<div class="top">
    	<div class="top_center">
            <ul class="top_bars">
            	...
            	<li><a href="toLoginServlet" style="color:red;">请登录</a>|</li>	
            	<li><a href="toRegisterServlet" style="color:red;">请注册</a>|</li>
            	</c:if>
            	<c:if test="${!empty sessionScope.user }">
            	<li><a href="toLoginServlet">退出</a>|</li>
            	<li><a href="user/myOrderServlet">我的订单<span class="jt_down"></span></a>|</li>
            	</c:if>
    ...
    <div class="header3">
    	...
    	<div class="h3_center">
        	<div >
            	<input type="text" name="keyname" style="height: 34px;width: 418px;">
                <input type="submit" value="点击提交" style=" background-color: #c5131e;color: #fff;font-size: 14px;
    font-weight: bold;
    height: 34px;
    line-height: 34px;
    text-align: center;
    width: 84px;">
        ...
        <div class="h3_right">
            ...
            <div class="tsc">
            	<a href="toShopCarServlet">去购物车结算</a>
	...
	<div class="container5">
    	<div class="cn5_top">
            <div class="cn5_top_x center01">
            	<a class="font20" href="toIndexServlet">书籍</a> 
               ...
               %>
                <div class="cn5topy_2">
                    ...
                    <div class="pro_ship">
                     ...
                     <form action="addShopCartItemServlet" method="post">
                    ...
                    <div class="pro_buy">
                        ...
                        <div><input type="submit" value="加入购物车"  class="pro_addshop" style="border: 0px;"></div>
