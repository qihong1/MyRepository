    ...
    <div class="container4">
        ...
        <div class="c4_b5">	
        	<div class="c4_b5_content">
            	...
            	<c:forEach items="${applicationScope.productByCategoryDetailId }" var="product">
                	<li class="c4_b5_c_box">
	                		<!--图片-->
	                    	<div class="c4_b5_c_box_pic">
	                        	<div class="c4b5_pic_view">
	                            	<a href="bookShowViewServlet?id=${product.id }"><img src="${product.img }"></a>
	                            </div>
	                        </div>
	                        <!--价钱-->
	                        <div class="c4_b5_c_box_txt">
	                        	<h1>￥ ${product.price }</h1>
	                            <h2><a href="bookShowViewServlet?id=${product.id }">${product.name }</a></h2>
	                        </div>
	                        <!--购买等操作-->
	                        <div class="c4b5_el">
	                        	<div class="c4b5_el_x">
